  ...
  return [
    {
      ...
      content:
        "This is a live note. Open this app in a second tab and watch edits sync between them in real time.",
      category: "Product",
    ...
    },
    {
      ...
      content:
        "Every note here is held in memory on the server. Restart the dev server and the list resets to these seeds.",
      category: "Research",
